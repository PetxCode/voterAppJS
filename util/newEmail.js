    ...
    <row>
      <columns small="12" >
        ...
        <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; padding: 10px" bg="#FFFFFF">
          ...
          <tr>
            <td align="center" style="padding:0px 40px 40px 40px"><p style="color:#262626; font-size:32px; text-align:center; font-family: Verdana, Geneva, sans-serif">Hello ${getUser.organisationName} Admin! <br> ${getUser.fullName}'s Account has been Activated</p>
                ...
                <br/>
                This message was sent to you to finally verified <%= name %> who tries to create an account with NYCC for the on going voting exercise <br/> <br/>

              It is obvious that he/she is a bolivian member of <strong> <${getUser.organisationName}</strong>!</br>
                <br/>
                <br/>
